...
/**
 * Rimuove i voti runtime generati dalle suite E2E.
 *
 * L'identità di voto è un UUID first-party, quindi la chiave salvata in
 * `vote_sessions.fingerprint` è `v1:<uuid>`. I dati seedati usano `test-fp-*`
 * e restano intatti.
 */
