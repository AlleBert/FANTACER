-- Migration: Vote validation pipeline cleanup (Turnstile -> BotD -> FingerprintJS -> DB once-per-day)
-- Date: 2026-08-07
-- Note: nessuna colonna nuova. vote_sessions.fingerprint ora riceve il visitorId di FingerprintJS.
