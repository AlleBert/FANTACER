...
export function ContactSection() {
  return (
    <section
      id="contact-section"
      className="relative w-full overflow-hidden bg-[linear-gradient(to_bottom,#4B00AB_0%,#a088db_40%,#efdeff_100%)]"
    >
          ...
          <div className="w-full lg:w-1/2 rounded-3xl border-[3px] border-[#231f20] bg-white p-4 md:p-6 lg:p-12 shadow-[6px_6px_0_#000]">
            ...
            <form className="flex flex-col gap-3 md:gap-4 lg:gap-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-5 py-2 md:py-3 lg:py-5 text-[clamp(0.8rem,1.5vw,1rem)] bg-white text-black font-black uppercase rounded-2xl border-[3px] border-[#231f20] focus:outline-none focus:shadow-[4px_4px_0_#000] focus:-translate-y-0.5 shadow-[2px_2px_0_#000] transition-all resize-none"
              />
              <Button
                type="submit"
