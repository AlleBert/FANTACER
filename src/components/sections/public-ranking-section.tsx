...
export function PublicRankingSection() {
  ...
  return (
    <section className="snap-screen relative w-full bg-gradient-to-b from-orange from-0% via-[#FF2FB2] via-25% to-[#FF2FB2] to-100% flex flex-col justify-between overflow-hidden py-4">
