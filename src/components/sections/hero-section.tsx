...
export function HeroSection({ onPlayClick }: HeroSectionProps) {
  return (
    <section className="snap-start relative app-screen w-full overflow-hidden bg-white">
      <div className="absolute inset-x-0 top-[calc(-1*var(--safe-area-inset-top,0px))] bottom-0">
        {/* Desktop Background */}
