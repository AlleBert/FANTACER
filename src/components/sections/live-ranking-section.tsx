  ...
  return (
    <SectionFrame theme="live-ranking" className="flex flex-col justify-between">
      <div ref={sectionRef} className="safe-shell content-max flex flex-col h-full min-h-0">
        <div className="flex flex-col items-center justify-center flex-1 min-h-0 gap-(--rythm-blk)">
          ...
          <div className="w-full max-w-2xl mx-auto">
            {!votingEnabled ? (
              ...
              <div className="w-full max-w-2xl mx-auto bg-white rounded-2xl border-[3px] border-black shadow-[4px_4px_0_#000] p-3 md:p-6 flex flex-col shrink min-h-0">
                <div className="no-scrollbar flex flex-col flex-1 min-h-0 overflow-y-auto gap-y-2 md:gap-y-3">
        ...
        <div className="flex-shrink-0 w-full flex justify-center pt-(--space-md)">
