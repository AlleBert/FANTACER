      ...
      <div className="flex flex-row justify-center items-center gap-4 sm:gap-6 md:gap-8 flex-wrap">
        {sponsors.map((sponsor) => (
          <a
            ...
            className="relative w-28 h-28 sm:w-36 sm:h-36 md:w-44 md:h-44 bg-white rounded-2xl md:rounded-[2rem] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-[3px] md:border-[4px] border-black flex items-center justify-center overflow-hidden transition-transform hover:-translate-y-2"
          >
            {sponsor.image_url ? (
              <img
