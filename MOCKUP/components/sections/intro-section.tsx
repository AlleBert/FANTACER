...
export function IntroSection() {
  return (
    <section className="relative w-full h-[100dvh] bg-[radial-gradient(circle_at_top_left,#FF8C23_0%,#FF2FB2_50%,#4B00AB_100%)] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 md:px-12 lg:px-24 grid lg:grid-cols-[0.7fr_1.3fr] gap-12 lg:gap-24 items-center">
        ...
        <div className="text-center lg:text-left mt-8 lg:mt-0 lg:ml-16 w-full max-w-[90vw] mx-auto lg:max-w-none lg:mx-0">
